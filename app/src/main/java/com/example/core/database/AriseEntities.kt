...
data class Alarm(
    ...
    val soundName: String = "Default Tone",
    val soundStartMs: Int = 0,
    val soundEndMs: Int = 30000
)
...
data class Routine(
    ...
    val steps: List<RoutineStep> = emptyList(), // Strongly typed list of steps/subtasks
    val isActive: Boolean = true,
    val syncStatus: String = "PENDING"
)
...
data class Challenge(
    ...
    val description: String = "",
    val config: ChallengeConfig = ChallengeConfig(), // strongly typed challenge parameters
